...
package edw_etl_aditya.test_0_1;
...
public class test implements TalendJob {
	...
	public void tS3Connection_2_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tS3Connection_2_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tDBBulkExec_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBBulkExec_2 = "consolidated_file_name";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (properties_tDBConnection_3 == null
						|| properties_tDBConnection_3.trim().length() == 0) {
				...
				String url_tDBConnection_3 = "jdbc:mysql://"
						+ context.SH_RR_Host + ":" + context.SH_Port + "/"
						+ context.SH_Database + "?"
						+ properties_tDBConnection_3;
				String dbUser_tDBConnection_3 = context.SH_Username;

				final String decryptedPassword_tDBConnection_3 = context.SH_Password;
				...
				globalMap.put("db_tDBConnection_3", context.SH_Database);
	...
	public void tDBConnection_4Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				StringBuilder sbuilder_tDBConnection_4 = new StringBuilder();
				sbuilder_tDBConnection_4.append("jdbc:redshift:");
				sbuilder_tDBConnection_4.append("//").append(context.EDW_Host)
						.append(":").append(context.EDW_Port).append("/")
						.append(context.EDW_Database).append("?loglevel=")
						.append(0);
				String url_tDBConnection_4 = sbuilder_tDBConnection_4
						.toString();
				String dbUser_tDBConnection_4 = context.EDW_Username;

				final String decryptedPassword_tDBConnection_4 = context.EDW_Password;
				String dbPwd_tDBConnection_4 = decryptedPassword_tDBConnection_4;

				java.sql.Connection conn_tDBConnection_4 = null;

				String driverClass_tDBConnection_4 = "com.amazon.redshift.jdbc42.Driver";
				...
				globalMap.put("schema_" + "tDBConnection_4", "public");
	...
	public void tDBConnection_5Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.Writer output_tDBConnection_5 = new java.io.FileWriter(
						"/Users/masteradmin/Downloads/TOS_DI-20180411_1414-V7.0.1/workspace/redshift-jdbc.log",
						true);
				java.io.PrintWriter logWriter_tDBConnection_5 = new java.io.PrintWriter(
						output_tDBConnection_5, true);
				globalMap.put("logWriter_tDBConnection_5",
						logWriter_tDBConnection_5);
				java.sql.DriverManager.setLogWriter(logWriter_tDBConnection_5);
				StringBuilder sbuilder_tDBConnection_5 = new StringBuilder();
				sbuilder_tDBConnection_5.append("jdbc:redshift:");
				sbuilder_tDBConnection_5.append("//").append(context.EDW_Host)
						.append(":").append(context.EDW_Port).append("/")
						.append(context.EDW_Database).append("?loglevel=")
						.append(1);
				String url_tDBConnection_5 = sbuilder_tDBConnection_5
						.toString();
				String dbUser_tDBConnection_5 = context.EDW_Username;

				final String decryptedPassword_tDBConnection_5 = context.EDW_Password;
				String dbPwd_tDBConnection_5 = decryptedPassword_tDBConnection_5;

				java.sql.Connection conn_tDBConnection_5 = null;

				String driverClass_tDBConnection_5 = "com.amazon.redshift.jdbc42.Driver";
				...
				globalMap.put("schema_" + "tDBConnection_5", "tj_dwh_prod");
	...
	public void tS3Connection_2Process(
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_2 = context.secretkey;

				com.amazonaws.auth.AWSCredentials credentials_tS3Connection_2 = new com.amazonaws.auth.BasicAWSCredentials(
						context.accesskey, decryptedPassword_tS3Connection_2);
				com.amazonaws.auth.AWSCredentialsProvider credentialsProvider_tS3Connection_2 = new com.amazonaws.internal.StaticCredentialsProvider(
				...
				com.amazonaws.services.s3.AmazonS3 conn_tS3Connection_2 = com.amazonaws.services.s3.AmazonS3ClientBuilder
						.standard()
						...
						.withCredentials(credentialsProvider_tS3Connection_2)
						.withClientConfiguration(cc_tS3Connection_2).build();

				// This method is just for test connection.
				conn_tS3Connection_2.getS3AccountOwner();

				globalMap
						.put("conn_" + "tS3Connection_2", conn_tS3Connection_2);
	...
	public static class row4Struct implements
		...
		final static byte[] commonByteArrayLock_EDW_ETL_ADITYA_test = new byte[0];
		static byte[] commonByteArray_EDW_ETL_ADITYA_test = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EDW_ETL_ADITYA_test.length) {
					if (length < 1024
							&& commonByteArray_EDW_ETL_ADITYA_test.length == 0) {
						commonByteArray_EDW_ETL_ADITYA_test = new byte[1024];
					} else {
						commonByteArray_EDW_ETL_ADITYA_test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_EDW_ETL_ADITYA_test, 0, length);
				strReturn = new String(commonByteArray_EDW_ETL_ADITYA_test, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EDW_ETL_ADITYA_test) {
	...
	public void tDBInput_7Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_7 = "select distinct fl.sh_order_id, l.consolidated_file_name, l.updated_at\nfrom mw_integration.ams_ftp_process_log l join m"
				...
				try {
					...
					while (rs_tDBInput_7.next()) {
						...
						if (colQtyInRs_tDBInput_7 < 1) {
							row4.sh_order_id = null;
						} else {

							row4.sh_order_id = routines.system.JDBCUtil
									.getString(rs_tDBInput_7, 1, false);
						}
						if (colQtyInRs_tDBInput_7 < 2) {
							row4.consolidated_file_name = null;
						} else {

							row4.consolidated_file_name = routines.system.JDBCUtil
						...
						if (colQtyInRs_tDBInput_7 < 3) {
							...
							if (rs_tDBInput_7.getString(3) != null) {
								String dateString_tDBInput_7 = rs_tDBInput_7
										.getString(3);
								if (!("0000-00-00")
										.equals(dateString_tDBInput_7)
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tDBInput_7)) {
									row4.updated_at = rs_tDBInput_7
											.getTimestamp(3);
								} else {
									row4.updated_at = (java.util.Date) year0_tDBInput_7
											.clone();
								}
							} else {
								row4.updated_at = null;
						...
						if (row4.sh_order_id != null) {
							sb_tFileOutputDelimited_2.append(row4.sh_order_id);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row4.consolidated_file_name != null) {
							sb_tFileOutputDelimited_2
									.append(row4.consolidated_file_name);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
	...
	public void tS3Put_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_2 = "EDW_RW/ordersfulfillmentstatusupdate.csv";

				int partSizeInBytes_tS3Put_2 = 5 * 1024 * 1024;

				Object fileOrStream_tS3Put_2 = "/tmp/ordersfulfillmentstatusupdate.csv";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test.class.getClassLoader()
					.getResourceAsStream(
							"edw_etl_aditya/test_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
	...
	private java.util.Map<String, Object> getSharedConnections4REST() {
		...
		connections.put("conn_tS3Connection_2",
				globalMap.get("conn_tS3Connection_2"));
...
/************************************************************************************************
 * 80987 characters generated by Talend Open Studio for Data Integration on the
 * 24 January, 2020 3:26:08 PM IST
 ************************************************************************************************/
