...
package edw_etl_aditya.job1_0_1;
	...
	public static class row7Struct implements
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EDW_ETL_ADITYA_job1.length) {
					if (length < 1024
							&& commonByteArray_EDW_ETL_ADITYA_job1.length == 0) {
						commonByteArray_EDW_ETL_ADITYA_job1 = new byte[1024];
					} else {
						commonByteArray_EDW_ETL_ADITYA_job1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_EDW_ETL_ADITYA_job1, 0, length);
				strReturn = new String(commonByteArray_EDW_ETL_ADITYA_job1, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job1.class.getClassLoader()
					.getResourceAsStream(
							"edw_etl_aditya/job1_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
