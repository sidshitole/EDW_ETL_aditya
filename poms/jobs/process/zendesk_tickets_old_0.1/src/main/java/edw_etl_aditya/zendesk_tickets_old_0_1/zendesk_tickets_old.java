...
package edw_etl_aditya.zendesk_tickets_old_0_1;
...
/**
 * Job: zendesk_tickets_old Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class zendesk_tickets_old implements TalendJob {
	...
	private final String jobName = "zendesk_tickets_old";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					zendesk_tickets_old.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(zendesk_tickets_old.this, new Object[] {
	...
	public static class row6Struct implements
		...
		final static byte[] commonByteArrayLock_EDW_ETL_ADITYA_zendesk_tickets_old = new byte[0];
		static byte[] commonByteArray_EDW_ETL_ADITYA_zendesk_tickets_old = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EDW_ETL_ADITYA_zendesk_tickets_old) {
	...
	public static class out1Struct implements
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EDW_ETL_ADITYA_zendesk_tickets_old.length) {
					if (length < 1024
							&& commonByteArray_EDW_ETL_ADITYA_zendesk_tickets_old.length == 0) {
						commonByteArray_EDW_ETL_ADITYA_zendesk_tickets_old = new byte[1024];
					} else {
						commonByteArray_EDW_ETL_ADITYA_zendesk_tickets_old = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_EDW_ETL_ADITYA_zendesk_tickets_old, 0,
						length);
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"ticket_id","ticket_external_id","channel","email_from_address","email_from_name","email_to_name","email_to_address","created_at","updated_at","type","subject","raw_subject","description","priority","status","recipient","requester_id","submitter_id","assignee_id","organization_id","group_id","collaborator_ids","follower_ids","email_cc_ids","forum_topic_id","problem_id","has_incidents","is_public","ticket_due_at","satisfaction_rating_score","followup_ids","brand_id","allow_channelback","allow_attachments","generated_timestamp","tags",});        
...
java.net.URL url_tHttpRequest_1 = new java.net.URL("https://tommyjohnwear.zendesk.com/api/v2/incremental/tickets.json?per_page=200&start_time="+globalMap.get("generated_timestamp")));

  java.net.Authenticator.setDefault(new java.net.Authenticator() {
      protected java.net.PasswordAuthentication getPasswordAuthentication() {

 
	final String decryptedPassword_tHttpRequest_1 = routines.system.PasswordEncryptUtil.decryptPassword("77c3108ae71963767e923a0eebbd52bd");

        return new java.net.PasswordAuthentication("bi@tommyjohnwear.com", decryptedPassword_tHttpRequest_1.toCharArray());
  }});
...
urlConn_tHttpRequest_1.setUseCaches(false);
  ...
  urlConn_tHttpRequest_1.setRequestProperty("accept", "application/json");
...
///////////////////////		
	    		...
	    		if(row1.ResponseContent != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(row1.ResponseContent)			
					          ;	
...
row3 = null;
    ...
    for(int i_tExtractJSONFields_1=0; isStructError_tExtractJSONFields_1 || (nodeList_tExtractJSONFields_1!=null && i_tExtractJSONFields_1 < nodeList_tExtractJSONFields_1.size());i_tExtractJSONFields_1++){
        ...
        if(!isStructError_tExtractJSONFields_1){
            ...
            try{
                org.dom4j.XPath xTmp0_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("id");
                    	...
                    	node_tExtractJSONFields_1 = xTmp0_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
	                        ...
	                        str_tExtractJSONFields_1 = xTmp0_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
	                                	...
	                                	if(xml_api_tExtractJSONFields_1.isDefNull(node_tExtractJSONFields_1)){
	                                    	row3.id = null;
	                                	}else if(xml_api_tExtractJSONFields_1.isEmpty(node_tExtractJSONFields_1) || xml_api_tExtractJSONFields_1.isMissing(node_tExtractJSONFields_1)){
	                                    	row3.id = null;
	                                	}else{
									
										row3.id = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp1_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("external_id");
	                ...
	                if(obj1_tExtractJSONFields_1 instanceof String || obj1_tExtractJSONFields_1 instanceof Number){
                    	...
                    	node_tExtractJSONFields_1 = xTmp1_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
	                        ...
	                        str_tExtractJSONFields_1 = xTmp1_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.external_id = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp2_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("via/channel");
                xTmp2_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj2_tExtractJSONFields_1 = xTmp2_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj2_tExtractJSONFields_1 instanceof String || obj2_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj2_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp2_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp2_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp3_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("via/source/from/address");
                xTmp3_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj3_tExtractJSONFields_1 = xTmp3_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj3_tExtractJSONFields_1 instanceof String || obj3_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj3_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp3_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp3_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp4_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("via/source/from/name");
                xTmp4_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj4_tExtractJSONFields_1 = xTmp4_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj4_tExtractJSONFields_1 instanceof String || obj4_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj4_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp4_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp4_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp5_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("via/source/to/name");
                xTmp5_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj5_tExtractJSONFields_1 = xTmp5_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj5_tExtractJSONFields_1 instanceof String || obj5_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj5_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp5_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp5_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp6_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("via/source/to/address");
                xTmp6_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj6_tExtractJSONFields_1 = xTmp6_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj6_tExtractJSONFields_1 instanceof String || obj6_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj6_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp6_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp6_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp9_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("type");
                xTmp9_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj9_tExtractJSONFields_1 = xTmp9_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj9_tExtractJSONFields_1 instanceof String || obj9_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj9_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp9_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp9_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp10_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("subject");
                xTmp10_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj10_tExtractJSONFields_1 = xTmp10_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj10_tExtractJSONFields_1 instanceof String || obj10_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj10_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp10_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp10_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp11_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("raw_subject");
                xTmp11_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj11_tExtractJSONFields_1 = xTmp11_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj11_tExtractJSONFields_1 instanceof String || obj11_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj11_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp11_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp11_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp12_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("description");
                xTmp12_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj12_tExtractJSONFields_1 = xTmp12_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj12_tExtractJSONFields_1 instanceof String || obj12_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj12_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp12_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp12_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp13_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("priority");
                xTmp13_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj13_tExtractJSONFields_1 = xTmp13_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj13_tExtractJSONFields_1 instanceof String || obj13_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj13_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp13_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp13_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp14_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("status");
                xTmp14_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj14_tExtractJSONFields_1 = xTmp14_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj14_tExtractJSONFields_1 instanceof String || obj14_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj14_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp14_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp14_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp15_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("recipient");
                xTmp15_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj15_tExtractJSONFields_1 = xTmp15_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj15_tExtractJSONFields_1 instanceof String || obj15_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj15_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp15_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp15_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp16_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("requester_id");
                xTmp16_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj16_tExtractJSONFields_1 = xTmp16_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj16_tExtractJSONFields_1 instanceof String || obj16_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj16_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp16_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp16_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.requester_id = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp17_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("submitter_id");
                xTmp17_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj17_tExtractJSONFields_1 = xTmp17_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj17_tExtractJSONFields_1 instanceof String || obj17_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj17_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp17_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp17_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.submitter_id = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp18_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("assignee_id");
                xTmp18_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj18_tExtractJSONFields_1 = xTmp18_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj18_tExtractJSONFields_1 instanceof String || obj18_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj18_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp18_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp18_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.assignee_id = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp19_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("organization_id");
                xTmp19_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj19_tExtractJSONFields_1 = xTmp19_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj19_tExtractJSONFields_1 instanceof String || obj19_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj19_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp19_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp19_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.organization_id = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp20_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("group_id");
                xTmp20_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj20_tExtractJSONFields_1 = xTmp20_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj20_tExtractJSONFields_1 instanceof String || obj20_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj20_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp20_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp20_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.group_id = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp21_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("collaborator_ids");
                xTmp21_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj21_tExtractJSONFields_1 = xTmp21_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj21_tExtractJSONFields_1 instanceof String || obj21_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj21_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp21_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp21_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.collaborator_ids = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp22_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("follower_ids");
                xTmp22_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj22_tExtractJSONFields_1 = xTmp22_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj22_tExtractJSONFields_1 instanceof String || obj22_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj22_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp22_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp22_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.follower_ids = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp23_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("email_cc_ids");
                xTmp23_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj23_tExtractJSONFields_1 = xTmp23_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj23_tExtractJSONFields_1 instanceof String || obj23_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj23_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp23_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp23_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.email_cc_ids = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp24_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("forum_topic_id");
                xTmp24_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj24_tExtractJSONFields_1 = xTmp24_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj24_tExtractJSONFields_1 instanceof String || obj24_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj24_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp24_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp24_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.forum_topic_id = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp25_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("problem_id");
                xTmp25_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj25_tExtractJSONFields_1 = xTmp25_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj25_tExtractJSONFields_1 instanceof String || obj25_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj25_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp25_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp25_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.problem_id = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp26_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("has_incidents");
                xTmp26_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj26_tExtractJSONFields_1 = xTmp26_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj26_tExtractJSONFields_1 instanceof String || obj26_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj26_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp26_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp26_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp27_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("is_public");
                xTmp27_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj27_tExtractJSONFields_1 = xTmp27_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj27_tExtractJSONFields_1 instanceof String || obj27_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj27_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp27_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp27_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp28_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("due_at");
                xTmp28_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj28_tExtractJSONFields_1 = xTmp28_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj28_tExtractJSONFields_1 instanceof String || obj28_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj28_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp28_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp28_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp29_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("satisfaction_rating/score");
                xTmp29_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj29_tExtractJSONFields_1 = xTmp29_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj29_tExtractJSONFields_1 instanceof String || obj29_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj29_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp29_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp29_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp30_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("followup_ids");
                xTmp30_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj30_tExtractJSONFields_1 = xTmp30_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj30_tExtractJSONFields_1 instanceof String || obj30_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj30_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp30_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp30_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.followup_ids = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp31_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("brand_id");
                xTmp31_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj31_tExtractJSONFields_1 = xTmp31_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj31_tExtractJSONFields_1 instanceof String || obj31_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj31_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp31_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp31_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.brand_id = ParserUtils.parseTo_Long(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp32_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("allow_channelback");
                xTmp32_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj32_tExtractJSONFields_1 = xTmp32_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj32_tExtractJSONFields_1 instanceof String || obj32_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj32_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp32_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp32_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp33_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("allow_attachments");
                xTmp33_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj33_tExtractJSONFields_1 = xTmp33_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj33_tExtractJSONFields_1 instanceof String || obj33_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj33_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp33_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp33_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp34_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("generated_timestamp");
                xTmp34_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj34_tExtractJSONFields_1 = xTmp34_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj34_tExtractJSONFields_1 instanceof String || obj34_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj34_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp34_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp34_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
										...
										row3.generated_timestamp = ParserUtils.parseTo_Integer(str_tExtractJSONFields_1);
									
										}
							
                org.dom4j.XPath xTmp35_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("created_at");
                xTmp35_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj35_tExtractJSONFields_1 = xTmp35_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj35_tExtractJSONFields_1 instanceof String || obj35_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj35_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp35_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp35_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp36_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("updated_at");
                xTmp36_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj36_tExtractJSONFields_1 = xTmp36_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj36_tExtractJSONFields_1 instanceof String || obj36_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj36_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp36_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp36_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
                ...
                org.dom4j.XPath xTmp37_tExtractJSONFields_1 = temp_tExtractJSONFields_1.createXPath("tags");
                xTmp37_tExtractJSONFields_1.setNamespaceURIs(xmlNameSpaceMap_tExtractJSONFields_1);
	                Object obj37_tExtractJSONFields_1 = xTmp37_tExtractJSONFields_1.evaluate(temp_tExtractJSONFields_1);
	                if(obj37_tExtractJSONFields_1 instanceof String || obj37_tExtractJSONFields_1 instanceof Number){
	                    node_tExtractJSONFields_1 = temp_tExtractJSONFields_1;
	                    str_tExtractJSONFields_1 = String.valueOf(obj37_tExtractJSONFields_1);
	                }else{
                    	node_tExtractJSONFields_1 = xTmp37_tExtractJSONFields_1.selectSingleNode(temp_tExtractJSONFields_1);
						
	                        str_tExtractJSONFields_1 = xTmp37_tExtractJSONFields_1.valueOf(temp_tExtractJSONFields_1);
...
out1_tmp.created_at = TalendDate.parseDate("yyyy-MM-dd HH:mm:ss",
row3.created_sr.substring(0,19).replace('T',' ')) ;
out1_tmp.updated_at = TalendDate.parseDate("yyyy-MM-dd HH:mm:ss",
row3.updated_sr.substring(0,19).replace('T',' ')) ;
...
out1_tmp.ticket_due_at = row3.due_at.equals("") ||
row3.due_at.equals(null)
?
null
:
...
out1_tmp.tags = row3.tags.replace('[',' ').replace(']',' ').replace('"',' ') ;
out1 = out1_tmp;
// ###############################
...
///////////////////////		
				...
				String[] row_tLogRow_2 = new String[36];
   				
	    		if(out1.ticket_id != null) { //              
                 row_tLogRow_2[0]=    						    
				                String.valueOf(out1.ticket_id)			
					          ;	
	    		...
	    		if(out1.ticket_external_id != null) { //              
                 row_tLogRow_2[1]=    						    
				                String.valueOf(out1.ticket_external_id)			
					          ;	
	    		...
	    		if(out1.email_from_address != null) { //              
                 row_tLogRow_2[3]=    						    
				                String.valueOf(out1.email_from_address)			
					          ;	
	    		...
	    		if(out1.email_from_name != null) { //              
                 row_tLogRow_2[4]=    						    
				                String.valueOf(out1.email_from_name)			
					          ;	
	    		...
	    		if(out1.email_to_name != null) { //              
                 row_tLogRow_2[5]=    						    
				                String.valueOf(out1.email_to_name)			
					          ;	
	    		...
	    		if(out1.email_to_address != null) { //              
                 row_tLogRow_2[6]=    						    
				                String.valueOf(out1.email_to_address)			
					          ;	
	    		...
	    		if(out1.created_at != null) { //              
                 row_tLogRow_2[7]=    						
								FormatterUtils.format_Date(out1.created_at, "dd-MM-yyyy")
					          ;	
	    		...
	    		if(out1.updated_at != null) { //              
                 row_tLogRow_2[8]=    						
								FormatterUtils.format_Date(out1.updated_at, "dd-MM-yyyy")
					          ;	
	    		...
	    		if(out1.raw_subject != null) { //              
                 row_tLogRow_2[11]=    						    
				                String.valueOf(out1.raw_subject)			
					          ;	
	    		...
	    		if(out1.requester_id != null) { //              
                 row_tLogRow_2[16]=    						    
				                String.valueOf(out1.requester_id)			
					          ;	
	    		...
	    		if(out1.submitter_id != null) { //              
                 row_tLogRow_2[17]=    						    
				                String.valueOf(out1.submitter_id)			
					          ;	
	    		...
	    		if(out1.assignee_id != null) { //              
                 row_tLogRow_2[18]=    						    
				                String.valueOf(out1.assignee_id)			
					          ;	
	    		...
	    		if(out1.organization_id != null) { //              
                 row_tLogRow_2[19]=    						    
				                String.valueOf(out1.organization_id)			
					          ;	
	    		...
	    		if(out1.collaborator_ids != null) { //              
                 row_tLogRow_2[21]=    						    
				                String.valueOf(out1.collaborator_ids)			
					          ;	
	    		...
	    		if(out1.follower_ids != null) { //              
                 row_tLogRow_2[22]=    						    
				                String.valueOf(out1.follower_ids)			
					          ;	
	    		...
	    		if(out1.email_cc_ids != null) { //              
                 row_tLogRow_2[23]=    						    
				                String.valueOf(out1.email_cc_ids)			
					          ;	
	    		...
	    		if(out1.forum_topic_id != null) { //              
                 row_tLogRow_2[24]=    						    
				                String.valueOf(out1.forum_topic_id)			
					          ;	
	    		...
	    		if(out1.problem_id != null) { //              
                 row_tLogRow_2[25]=    						    
				                String.valueOf(out1.problem_id)			
					          ;	
	    		...
	    		if(out1.has_incidents != null) { //              
                 row_tLogRow_2[26]=    						    
				                String.valueOf(out1.has_incidents)			
					          ;	
	    		...
	    		if(out1.ticket_due_at != null) { //              
                 row_tLogRow_2[28]=    						
								FormatterUtils.format_Date(out1.ticket_due_at, "dd-MM-yyyy")
					          ;	
	    		...
	    		if(out1.satisfaction_rating_score != null) { //              
                 row_tLogRow_2[29]=    						    
				                String.valueOf(out1.satisfaction_rating_score)			
					          ;	
	    		...
	    		if(out1.followup_ids != null) { //              
                 row_tLogRow_2[30]=    						    
				                String.valueOf(out1.followup_ids)			
					          ;	
	    		...
	    		if(out1.allow_channelback != null) { //              
                 row_tLogRow_2[32]=    						    
				                String.valueOf(out1.allow_channelback)			
					          ;	
	    		...
	    		if(out1.allow_attachments != null) { //              
                 row_tLogRow_2[33]=    						    
				                String.valueOf(out1.allow_attachments)			
					          ;	
	    		...
	    		if(out1.generated_timestamp != null) { //              
                 row_tLogRow_2[34]=    						    
				                String.valueOf(out1.generated_timestamp)			
					          ;	
 ...
 */
	...
	public static void main(String[] args) {
		final zendesk_tickets_old zendesk_tickets_oldClass = new zendesk_tickets_old();

		int exitCode = zendesk_tickets_oldClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = zendesk_tickets_old.class
					.getClassLoader().getResourceAsStream(
							"edw_etl_aditya/zendesk_tickets_old_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = zendesk_tickets_old.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : zendesk_tickets_old");
		}
...
/************************************************************************************************
 * 221032 characters generated by Talend Open Studio for Data Integration on the
 * 7 February, 2020 4:10:14 PM IST
 ************************************************************************************************/
