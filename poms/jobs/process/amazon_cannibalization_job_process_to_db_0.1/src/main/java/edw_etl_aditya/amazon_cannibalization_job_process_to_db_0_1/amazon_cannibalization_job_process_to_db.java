...
package edw_etl_aditya.amazon_cannibalization_job_process_to_db_0_1;
...
/**
 * Job: amazon_cannibalization_job_process_to_db Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class amazon_cannibalization_job_process_to_db implements TalendJob {
	...
	private final String jobName = "amazon_cannibalization_job_process_to_db";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					amazon_cannibalization_job_process_to_db.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(
									amazon_cannibalization_job_process_to_db.this,
	...
	public static class OUTPUTStruct implements
		...
		final static byte[] commonByteArrayLock_EDW_ETL_ADITYA_amazon_cannibalization_job_process_to_db = new byte[0];
		static byte[] commonByteArray_EDW_ETL_ADITYA_amazon_cannibalization_job_process_to_db = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EDW_ETL_ADITYA_amazon_cannibalization_job_process_to_db.length) {
					if (length < 1024
							&& commonByteArray_EDW_ETL_ADITYA_amazon_cannibalization_job_process_to_db.length == 0) {
						commonByteArray_EDW_ETL_ADITYA_amazon_cannibalization_job_process_to_db = new byte[1024];
					} else {
						commonByteArray_EDW_ETL_ADITYA_amazon_cannibalization_job_process_to_db = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_EDW_ETL_ADITYA_amazon_cannibalization_job_process_to_db,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EDW_ETL_ADITYA_amazon_cannibalization_job_process_to_db) {
				...
				try {
					...
					this.order_email = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.order_email, dos);
		...
		public String toString() {
			...
			sb.append(",order_email=" + order_email);
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.sql.Statement stmtTruncCount_tDBOutput_3 = conn_tDBOutput_3
						.createStatement();
				java.sql.ResultSet rsTruncCount_tDBOutput_3 = stmtTruncCount_tDBOutput_3
				...
				rsTruncCount_tDBOutput_3.close();
				stmtTruncCount_tDBOutput_3.close();
				java.sql.Statement stmtTrunc_tDBOutput_3 = conn_tDBOutput_3
						.createStatement();
				stmtTrunc_tDBOutput_3.executeUpdate("TRUNCATE TABLE \""
						+ tableName_tDBOutput_3 + "\"");
				deletedCount_tDBOutput_3 += rsTruncCountNumber_tDBOutput_3;
				stmtTrunc_tDBOutput_3.close();
				...
				class BufferLine_tDBOutput_3 {
					...
					public BufferLine_tDBOutput_3 c2(String order_email) {
					...
					public BufferLine_tDBOutput_3 c3(String order_name) {
					...
					public BufferLine_tDBOutput_3 c4(
							java.util.Date order_processed_at) {
					...
					public BufferLine_tDBOutput_3 c5(String order_sales_channel) {
					...
					public BufferLine_tDBOutput_3 c6(Integer order_instance) {
					...
					public BufferLine_tDBOutput_3 c10(
							java.util.Date edw_created_at) {
				...
				String insert_tDBOutput_3 = "INSERT INTO \""
						+ tableName_tDBOutput_3
						+ "\" (\"customer_key\",\"amazon_customer_key\",\"order_email\",\"order_name\",\"order_processed_at\",\"order_sales_channel\",\"order_instance\",\"is_overall_first_order\",\"is_first_tj_ecomm_customer\",\"is_first_amazon_customer\",\"edw_created_at\") VALUES "
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						{ // start of Var scope
							...
							OUTPUT_tmp.order_email = row2.email;
						...
						if (OUTPUT != null) {
							...
							int countertDBOutput_3 = rowCounttDBOutput_3 * (11) + 1;
							...
							.c0(OUTPUT.customer_key)
									...
									.c2(OUTPUT.order_email)
									.c3(OUTPUT.order_name)
									.c4(OUTPUT.order_processed_at)
									.c5(OUTPUT.order_sales_channel)
									.c6(OUTPUT.order_instance)
									.c7(OUTPUT.is_overall_first_order)
									.c8(OUTPUT.is_first_tj_ecomm_customer)
									.c9(OUTPUT.is_first_amazon_customer)
									.c10(OUTPUT.edw_created_at);
				...
				if (rowCounttDBOutput_3 != 0) {
					...
					for (BufferLine_tDBOutput_3 bufferLtDBOutput_3 : exInsertColValueListtDBOutput_3) {
						int counttDBOutput_3 = rowCounttDBOutput_3 * (11) + 1;
						...
						if (bufferLtDBOutput_3.order_email == null) {
							pstmt_tDBOutput_3.setNull(counttDBOutput_3,
									java.sql.Types.VARCHAR);
							...
							pstmt_tDBOutput_3.setString(counttDBOutput_3,
									bufferLtDBOutput_3.order_email);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class BufferLine_tDBOutput_5 {
					...
					public BufferLine_tDBOutput_5 c2(String order_email) {
						this.order_email = order_email;
						return this;
					}
					...
					public BufferLine_tDBOutput_5 c3(String order_name) {
						this.order_name = order_name;
						return this;
					}
					...
					public BufferLine_tDBOutput_5 c4(
							java.util.Date order_processed_at) {
						this.order_processed_at = order_processed_at;
						return this;
					}
					...
					public BufferLine_tDBOutput_5 c5(String order_sales_channel) {
						this.order_sales_channel = order_sales_channel;
						return this;
					}
					...
					public BufferLine_tDBOutput_5 c6(Integer order_instance) {
						this.order_instance = order_instance;
						return this;
					}
					...
					public BufferLine_tDBOutput_5 c10(
							java.util.Date edw_created_at) {
						this.edw_created_at = edw_created_at;
						return this;
					}
				...
				String dbquery_tDBInput_3 = "SELECT COALESCE(email,'Email not found in TJ') email, name, processed_at, \ncase when sales_channel in ('SHOPIFY','SOLID"
						...
						+ "y ranked.shipping_address_new,ranked.add_rank;";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						{ // start of Var scope
							...
							OUTPUTT_tmp.order_email = row3.email;
						...
						if (OUTPUTT != null) {
							...
							int countertDBOutput_5 = rowCounttDBOutput_5 * (11) + 1;
							...
							.c0(OUTPUTT.customer_key)
									...
									.c2(OUTPUTT.order_email)
									.c3(OUTPUTT.order_name)
									.c4(OUTPUTT.order_processed_at)
									.c5(OUTPUTT.order_sales_channel)
									.c6(OUTPUTT.order_instance)
									.c7(OUTPUTT.is_overall_first_order)
									.c8(OUTPUTT.is_first_tj_ecomm_customer)
									.c9(OUTPUTT.is_first_amazon_customer)
									.c10(OUTPUTT.edw_created_at);
				...
				if (rowCounttDBOutput_5 != 0) {
					...
					for (BufferLine_tDBOutput_5 bufferLtDBOutput_5 : exInsertColValueListtDBOutput_5) {
						int counttDBOutput_5 = rowCounttDBOutput_5 * (11) + 1;
						...
						if (bufferLtDBOutput_5.order_email == null) {
							pstmt_tDBOutput_5.setNull(counttDBOutput_5,
									java.sql.Types.VARCHAR);
							...
							pstmt_tDBOutput_5.setString(counttDBOutput_5,
									bufferLtDBOutput_5.order_email);
	...
	public void tDBRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tDBRow_1 = "update public.fact_ecomm_amazon_cannibalization\nset amazon_customer_key = ac.amazon_customer_key\nFROM public.dim_amazon"
						+ "_customers ac\nwhere public.fact_ecomm_amazon_cannibalization.order_email = ac.customer_tj_ecomm_email"
	...
	public static void main(String[] args) {
		final amazon_cannibalization_job_process_to_db amazon_cannibalization_job_process_to_dbClass = new amazon_cannibalization_job_process_to_db();

		int exitCode = amazon_cannibalization_job_process_to_dbClass
				.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = amazon_cannibalization_job_process_to_db.class
					.getClassLoader().getResourceAsStream(
							"edw_etl_aditya/amazon_cannibalization_job_process_to_db_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = amazon_cannibalization_job_process_to_db.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : amazon_cannibalization_job_process_to_db");
		}
...
/************************************************************************************************
 * 227021 characters generated by Talend Open Studio for Data Integration on the
 * 15 January, 2020 7:31:03 PM IST
 ************************************************************************************************/
