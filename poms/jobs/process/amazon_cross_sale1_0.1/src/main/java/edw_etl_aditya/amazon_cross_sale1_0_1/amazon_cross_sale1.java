...
package edw_etl_aditya.amazon_cross_sale1_0_1;
...
/**
 * Job: amazon_cross_sale1 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class amazon_cross_sale1 implements TalendJob {
	...
	private final String jobName = "amazon_cross_sale1";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					amazon_cross_sale1.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(amazon_cross_sale1.this, new Object[] { e,
	...
	public static class row10Struct implements
		...
		final static byte[] commonByteArrayLock_EDW_ETL_ADITYA_amazon_cross_sale1 = new byte[0];
		static byte[] commonByteArray_EDW_ETL_ADITYA_amazon_cross_sale1 = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EDW_ETL_ADITYA_amazon_cross_sale1) {
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_2 = "select count(1) as countss from process_logs where process_state = 'Running' and process_name = 'dim_amazon_customers'";
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							if (rs_tDBInput_2.getObject(1) != null) {
								row10.countss = rs_tDBInput_2.getInt(1);
							} else {
								row10.countss = null;
							}
						}
	...
	public void tDBRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tDBRow_1 = "insert into process_logs (process_name, start_time, process_state) values ('dim_amazon_customers',current_timestamp,'Ru"
						+ "nning')";
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_3 = "select coalesce(max(last_id),0) as iddd from process_logs where process_name = 'dim_amazon_customers' and process_state"
						+ " = 'Completed';";
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							if (rs_tDBInput_3.getObject(1) != null) {
								row11.iddd = rs_tDBInput_3.getLong(1);
							} else {
								row11.iddd = null;
							}
						}
	...
	public static class outputStruct implements
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EDW_ETL_ADITYA_amazon_cross_sale1.length) {
					if (length < 1024
							&& commonByteArray_EDW_ETL_ADITYA_amazon_cross_sale1.length == 0) {
						commonByteArray_EDW_ETL_ADITYA_amazon_cross_sale1 = new byte[1024];
					} else {
						commonByteArray_EDW_ETL_ADITYA_amazon_cross_sale1 = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_EDW_ETL_ADITYA_amazon_cross_sale1, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EDW_ETL_ADITYA_amazon_cross_sale1) {
				...
				try {
					...
					this.customer_email = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.customer_email, dos);
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "amazoncustomers";
				...
				java.sql.Statement stmtTruncCount_tDBOutput_1 = conn_tDBOutput_1
						.createStatement();
				java.sql.ResultSet rsTruncCount_tDBOutput_1 = stmtTruncCount_tDBOutput_1
				...
				rsTruncCount_tDBOutput_1.close();
				stmtTruncCount_tDBOutput_1.close();
				java.sql.Statement stmtTrunc_tDBOutput_1 = conn_tDBOutput_1
						.createStatement();
				stmtTrunc_tDBOutput_1.executeUpdate("TRUNCATE TABLE \""
						+ tableName_tDBOutput_1 + "\"");
				deletedCount_tDBOutput_1 += rsTruncCountNumber_tDBOutput_1;
				stmtTrunc_tDBOutput_1.close();
				...
				class BufferLine_tDBOutput_1 {
					...
					public BufferLine_tDBOutput_1 c1(String customer_email) {
				...
				String insert_tDBOutput_1 = "INSERT INTO \""
						+ tableName_tDBOutput_1
						+ "\" (\"shipping_address\",\"customer_email\") VALUES "
				...
				String dbquery_tDBInput_1 = "SELECT CAST(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(shipping_address), 'UNITED STATES', 'US'),'PUERTO RICO','PR'),'VIRGIN"
						+ " ISLANDS (BRITISH)','BVI'),'  ',' ') AS CHAR) shipping_address_new, customer_email\nFROM netsuite_staging.sales_orders \nW"
						+ "HERE id > "
						+ context.iddd
						+ " and customer_id=1409858\nAND netsuite_order_number LIKE 'SO%'\norder by shipping_address_new";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							row1.customer_email = null;
						} else {

							row1.customer_email = routines.system.JDBCUtil
						...
						{ // start of Var scope
							...
							output_tmp.customer_email = row1.customer_email;
							output = output_tmp;
							// ###############################
						...
						if (output != null) {
							...
							int countertDBOutput_1 = rowCounttDBOutput_1 * (2) + 1;
				...
				if (rowCounttDBOutput_1 != 0) {
					...
					for (BufferLine_tDBOutput_1 bufferLtDBOutput_1 : exInsertColValueListtDBOutput_1) {
						int counttDBOutput_1 = rowCounttDBOutput_1 * (2) + 1;
						...
						if (bufferLtDBOutput_1.customer_email == null) {
							pstmt_tDBOutput_1.setNull(counttDBOutput_1,
									java.sql.Types.VARCHAR);
							...
							pstmt_tDBOutput_1.setString(counttDBOutput_1,
									bufferLtDBOutput_1.customer_email);
	...
	public void tDBInput_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_5 = "select max(id) as maxidd from netsuite_staging.sales_orders";
					...
					while (rs_tDBInput_5.next()) {
						...
						if (colQtyInRs_tDBInput_5 < 1) {
							...
							if (rs_tDBInput_5.getObject(1) != null) {
								row12.maxidd = rs_tDBInput_5.getLong(1);
							} else {
								row12.maxidd = null;
							}
						}
	...
	public void tDBRow_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tDBRow_2 = "update process_logs\nset process_state = 'Completed', end_time = CURRENT_TIMESTAMP,\nLast_id = "
						+ context.maxidd
						+ ", line_inserted = "
						+ ((Integer) globalMap
								.get("tDBOutput_1_NB_LINE_INSERTED"))
						+ "\nwhere process_name = 'dim_amazon_customers' and process_state = 'Running';";
	...
	public static class after_tDBInput_4Struct implements
			routines.system.IPersistableRow<after_tDBInput_4Struct> {
		final static byte[] commonByteArrayLock_EDW_ETL_ADITYA_amazon_cross_sale1 = new byte[0];
		static byte[] commonByteArray_EDW_ETL_ADITYA_amazon_cross_sale1 = new byte[0];
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_2 = "dim_amazon_customers";
				...
				class BufferLine_tDBOutput_2 {
					...
					public BufferLine_tDBOutput_2 c0(String shipping_address) {
						this.shipping_address = shipping_address;
						return this;
					}
					...
					public BufferLine_tDBOutput_2 c2(
							String customer_tj_ecomm_email) {
				...
				String dbquery_tDBInput_4 = "select shipping_address, customer_email\nfrom public.amazoncustomers\nwhere shipping_address not in (select shipping_addr"
						+ "ess from public.dim_amazon_customers)\norder by amazon_customer_key";
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 1) {
							row2.shipping_address = null;
						} else {

							row2.shipping_address = routines.system.JDBCUtil
									.getString(rs_tDBInput_4, 1, false);
						}
						if (colQtyInRs_tDBInput_4 < 2) {
							row2.customer_email = null;
						} else {

							row2.customer_email = routines.system.JDBCUtil
						...
						if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
							...
							row3HashKey.shipping_address_new = row2.shipping_address;
						...
						if (tHash_Lookup_row3 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.shipping_address_new = '"
							// + row3HashKey.shipping_address_new + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							copyOfoutput_tmp.shipping_address = row2.shipping_address;
							copyOfoutput_tmp.customer_amazon_email = row2.customer_email;
							copyOfoutput_tmp.customer_tj_ecomm_email = row3.email;
						...
						if (copyOfoutput != null) {
							...
							if (copyOfoutput.shipping_address == null) {
								...
								pstmt_tDBOutput_2.setString(countertDBOutput_2,
										copyOfoutput.shipping_address);

							}

							countertDBOutput_2++;

							if (copyOfoutput.customer_amazon_email == null) {
								pstmt_tDBOutput_2.setNull(countertDBOutput_2,
										java.sql.Types.VARCHAR);
								...
								pstmt_tDBOutput_2.setString(countertDBOutput_2,
										copyOfoutput.customer_amazon_email);

							}

							countertDBOutput_2++;

							if (copyOfoutput.customer_tj_ecomm_email == null) {
								pstmt_tDBOutput_2.setNull(countertDBOutput_2,
										java.sql.Types.VARCHAR);
								...
								pstmt_tDBOutput_2.setString(countertDBOutput_2,
										copyOfoutput.customer_tj_ecomm_email);
							...
							.c0(copyOfoutput.shipping_address)
									.c1(copyOfoutput.customer_amazon_email)
									.c2(copyOfoutput.customer_tj_ecomm_email);
				...
				if (rowCounttDBOutput_2 != 0) {
					...
					for (BufferLine_tDBOutput_2 bufferLtDBOutput_2 : exInsertColValueListtDBOutput_2) {
						...
						if (bufferLtDBOutput_2.shipping_address == null) {
							...
							pstmt_tDBOutput_2.setString(counttDBOutput_2,
									bufferLtDBOutput_2.shipping_address);

						}

						counttDBOutput_2++;

						if (bufferLtDBOutput_2.customer_amazon_email == null) {
							pstmt_tDBOutput_2.setNull(counttDBOutput_2,
									java.sql.Types.VARCHAR);
							...
							pstmt_tDBOutput_2.setString(counttDBOutput_2,
									bufferLtDBOutput_2.customer_amazon_email);

						}

						counttDBOutput_2++;

						if (bufferLtDBOutput_2.customer_tj_ecomm_email == null) {
							pstmt_tDBOutput_2.setNull(counttDBOutput_2,
									java.sql.Types.VARCHAR);
							...
							pstmt_tDBOutput_2.setString(counttDBOutput_2,
									bufferLtDBOutput_2.customer_tj_ecomm_email);
	...
	public void tDBInput_7Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_7 = "select email, shipping_address_new from edw_staging.overall_orders";
				...
				try {
					...
					while (rs_tDBInput_7.next()) {
						...
						row3_HashRow.shipping_address_new = row3.shipping_address_new;
	...
	public static void main(String[] args) {
		final amazon_cross_sale1 amazon_cross_sale1Class = new amazon_cross_sale1();

		int exitCode = amazon_cross_sale1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = amazon_cross_sale1.class
					.getClassLoader().getResourceAsStream(
							"edw_etl_aditya/amazon_cross_sale1_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = amazon_cross_sale1.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : amazon_cross_sale1");
		}
...
/************************************************************************************************
 * 162320 characters generated by Talend Open Studio for Data Integration on the
 * 7 January, 2020 6:09:11 PM IST
 ************************************************************************************************/
